import { GenericResponse, VerifiedResponse, CacheCowStream } from '../types/api';
export default class CacheCowApi {
    ...
    responseHasErrors(response: GenericResponse): boolean;
    maybeReAuth(verified: VerifiedResponse): void;
    auth(): Promise<void>;
    verify(): Promise<void>;
    getStreams(muNames: string[]): Promise<CacheCowStream[]>;
}
